  ...
  (
    ...
    const startAnimation = useCallback(() => {
      ...
      terminals.forEach((selector, index) => {
        animate(
          ...
          { duration: 0.8, delay: 0.2 + index * 0.15, repeat: Infinity, repeatDelay: 1, ease: "easeInOut" },
        );
      });
    }, [animate]);
    ...
    return (
      ...
      >
        ...
        >
          <motion.path className="brain-outline" d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A 4 4 0 1 0 12 18Z" />
