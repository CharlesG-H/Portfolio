...
const TargetIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        <motion.circle className="circle-outer" cx="12" cy="12" r="10" style={{ transformOrigin: "12px 12px" }} />
        <motion.circle className="circle-middle" cx="12" cy="12" r="6" style={{ transformOrigin: "12px 12px" }} />
        <motion.circle className="circle-inner" cx="12" cy="12" r="2" style={{ transformOrigin: "12px 12px" }} />
      </motion.svg>
    );
  },
);
