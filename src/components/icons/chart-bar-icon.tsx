  ...
  (
    ...
    return (
      ...
      >
        ...
        <motion.path d="M3 13a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v6a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" className="bar-1" style={{ transformOrigin: "6px 20px" }} />
        <motion.path d="M9 5a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v14a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" className="bar-2" style={{ transformOrigin: "12px 20px" }} />
        <motion.path d="M15 9a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v10a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" className="bar-3" style={{ transformOrigin: "18px 20px" }} />
